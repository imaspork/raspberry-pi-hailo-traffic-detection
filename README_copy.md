...
Welcome to the Burlingame Red Light Watcher repository. This repo consists of three applications that utilize the Hailo Raspberry Pi 5 for real-time object detection with the HAILO-8L AI chip. This particular example is focused around detecting whether cars have ran a red light.

Visit the [Website](https://redlightwatcher.com/) for a live example.

## Table of Contents

- [Burlingame Red Light Watcher](#burlingame-red-light-running-object-detection)
